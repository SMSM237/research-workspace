...
| 구성 | 버전 | 포함 내용 |
|---|---|---|
| 대시보드 / Figure First Reader | 0.7.4 | 설치된 플러그인이 포함된 빈 Vault, PC·모바일 홈, 전체 소스 |
...
리포트의 제목·개념·태그를 기기 안에서 비교하여 공통 주제를 묶습니다. 점을 누르면 PC에서는 오른쪽에 리포트를 열고 대시보드를 유지합니다. 모바일에서는 리포트 탭을 엽니다. 확대 버튼에서는 관련 논문과 연결 이유를 볼 수 있습니다. 공통 주제 연결은 탐색용 추정이며 인용·인과 관계를 의미하지 않습니다. 현재 분류 사전은 생의학 분야 중심이며, 다른 분야는 공통 개념 이름·태그 또는 직접 노트 링크로 연결할 수 있습니다. 개념 자료가 없는 논문은 제목·태그만 사용합니다.
